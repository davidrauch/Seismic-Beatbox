...
For more details, see "Create React App README" below.

## Data

Earthquake data is loaded from the [USGS earthquake feed](https://earthquake.usgs.gov/earthquakes/feed/v1.0/geojson.php).
By default, the app loads data on start and checks for new data every 30 seconds.
